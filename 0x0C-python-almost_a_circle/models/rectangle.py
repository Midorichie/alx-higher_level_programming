...
class Rectangle(Base):
    ...
    @property
    def width(self):
        """This is the public getter and setter for width"""
        return self.__width
    ...
    @property
    def x(self):
        """This is the public getter and setter for x"""
        return self.__x
    ...
    @property
    def y(self):
        """This is the public getter and setter for y"""
        return self.__y
    ...
    def y(self, value):
        """The y setter
        Args:
            value: the value to be set for the width
        Raises:
            TypeError: x must be an integer
            ValueError: x must be > 0
        """
    ...
    def display(self):
        ...
        and also takes into account the coordinates.
        """
    ...
    def update(self, *args, **kwargs):
        ...
        Args:
            attribute order(tuple): holds the order of the updated attributes
            args: arbituary positional arguments
            kwargs: arbituary keyworded arguments
        Raises:
